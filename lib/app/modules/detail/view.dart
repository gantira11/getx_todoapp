...
import 'package:getx_todoapp/app/modules/detail/widgets/doing_list.dart';
import 'package:getx_todoapp/app/modules/detail/widgets/done_list.dart';
                  ...
                  suffixIcon: IconButton(
                    onPressed: () {
                      if (homeCtrl.formKey.currentState!.validate()) {
                        var success = homeCtrl.addTodo(homeCtrl.titleCtrl.text);
                        if (success) {
                          EasyLoading.showSuccess('Todo item add uccess');
                        } else {
